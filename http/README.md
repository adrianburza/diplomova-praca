...
> ⚠️ **Dôležité:** Táto implementácia bola vytvorená v rámci diplomovej práce ako demonštračný príklad nezabezpečenej komunikácie v prostredí IoT. Slúžila na identifikáciu základných zraniteľností, testovanie možných útokov a poskytla východiskový rámec pre porovnanie s bezpečnými spôsobmi prenosu údajov.
